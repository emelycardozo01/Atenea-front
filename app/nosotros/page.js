...
const page = () => {
  return (
    <div className="flex border-[#223d86] border rounded-3xl p-6 px-20 w-[50%]">
      <div className="">
        <div className="mb-9 card-header text-4xl font-bold text-[#192752] text-center">
          Nosotros
        </div>

        <div className="mb-3 card-header text-center text-2xl font-bold text-[#192752]">
          Misión
        </div>
